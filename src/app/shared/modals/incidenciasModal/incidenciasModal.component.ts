import {Component, OnInit, Input, Output, EventEmitter} from '@angular/core';
 ...
 @Component({
  selector: 'app-incidenciasModal', templateUrl: './incidenciasModal.component.html', styleUrls: ['./incidenciasModal.component.css']
})
export class IncidenciasModalComponent {
